...
public class DirectAllModelTest {

    @Test
    public void testDirectAllModel() throws IOException, IllegalAccessException, NoSuchFieldException {
        System.out.println("开始测试阿里AI全模态模型功能...");
        ...
        setField(aliyunAIService, "aliyunAllModelEnabled", true);
        setField(aliyunAIService, "aliyunAllModel", "qwen-omni-turbo");
        setField(aliyunAIService, "aliyunAllModelApiKey", "test-allmodel-api-key");
        ...
        // 测试processImageWithMultimodal方法（使用全模态模型）
        try {
            System.out.println("调用processImageWithMultimodal方法（全模态模型）...");
